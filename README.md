...
This is a social media dashboard to demonstrate the use of postgreSQL and Redis (NoSQL). It currently uses Supabase, Redis, NextJS, Tailwind, and Shadcn + Lucide for styling.
